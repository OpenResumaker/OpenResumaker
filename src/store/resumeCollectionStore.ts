      ...
      data: [
        {
          ...
          title: '阿里巴巴',
          subtitle: '高级前端工程师',
          secondarySubtitle: '杭州',
          startDate: '2022-03',
          endDate: '2024-06',
          description: '负责核心业务前端开发，参与架构设计和技术选型。',
        },
        {
          id: '2',
          title: '字节跳动',
          subtitle: '前端工程师',
          secondarySubtitle: '北京',
          startDate: '2020-07',
          endDate: '2022-02',
          description: '参与多个大型项目开发，负责性能优化和用户体验提升。',
        },
      ],
    },
  ],
...
// 批量导入简历
export const importBatchResumesAtom = atom(null, (get, set, resumes: Resume[]) => {
  const collection = get(resumeCollectionAtom);
  const now = new Date().toISOString();
